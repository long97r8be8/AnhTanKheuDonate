...
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)), -- Màu đỏ
    ColorSequenceKeypoint.new(0.167, Color3.fromRGB(255, 255, 0)), -- Màu vàng
    ColorSequenceKeypoint.new(0.333, Color3.fromRGB(0, 255, 0)), -- Màu xanh lá cây
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 255)), -- Màu xanh lam
    ColorSequenceKeypoint.new(0.667, Color3.fromRGB(0, 0, 255)), -- Màu xanh dương
    ColorSequenceKeypoint.new(0.833, Color3.fromRGB(255, 0, 255)), -- Màu tím
    ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 0)) -- Màu đỏ
}
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO LH Hub<Color=/>"):Display()
...
local StatsTab = WazureGui:MakeTab("Stats")
local PlayerTab = WazureGui:MakeTab("Player")
local IslandTab = WazureGui:MakeTab("Island")
local FruitsTab = WazureGui:MakeTab("Fruits")
local RaidTab = WazureGui:MakeTab("Raid")
local VisualTab = WazureGui:MakeTab("Visual")
local Status SeverTab = WazureGui:MakeTab("Status Sever")
local RaceV4Tab = WazureGui:MakeTab("RaceV4")
local ShopTab = WazureGui:MakeTab("Shop")
local MiscTab = WazureGui:MakeTab("Misc")
...
local Label = MainTab:MakeLabel("This is a label")
	...
	["Multi"] = false,
	["Options"] = {"Normal Attack", "Fast Attack", "LongDepZai Att"},
	["Default"] = {"Fast Attack"},
	...
	elseif _G.FastAttackGamer144_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.02
	elseif _G.FastAttackGamer144YTB_Mode == "LongDepZai Att" then
		_G.Fast_Delay = 0.001
	end
end)
