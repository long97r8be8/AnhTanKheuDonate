...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Welcome Con CẶC LH Hub!<Color=/>"):Display()
    wait(.5)
    ...
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: LH Hub<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "LH Hub", HidePremium = false, IntroText = "LH Hub", SaveConfig = true, ConfigFolder = "LH Hub"})
...
W:AddLabel("Script By LongZzZ")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Welcome to LH Hub Con Cặc Đụ Mẹ Mày!")
